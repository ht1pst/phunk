  ...
  return (
    <section className="bg-black relative overflow-hidden h-240 md:h-150 lg:h-170 pt-20">
      ...
      <div>
        ...
        {/* === Content Box === */}
        <div className="flex lg:w-330 md:w-170 w-90 lg:h-105 h-140 border border-gray-700 mx-auto rounded-b-xl relative 
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[100%] lg:w-[85%] rounded-b-xl md:h-100 h-100 max-w-[2100px] lg:-[200px] bg-gradient-to-t from-[#1fb8ff] via-[#001122] to-transparent opacity-80 rounded-t-[40px]"></div>
          ...
          <div className="flex relative  flex-col md:flex-row px-7 lg:px-10 lg:flex-row lg:items-center lg:justify-center md:justify-start lg:gap-20 gap-10 md:gap-2 transition-opacity duration-500">
            ...
            <div className="transition-all duration-500 ease-in-out  pt-10">
              ...
              <p className="text-lg md:text-sm lg:w-100 lg:font-semibold md:w-100 w-80 text-white mt-7">{text}</p>
