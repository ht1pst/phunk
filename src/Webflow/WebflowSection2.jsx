...
function WebflowSection2() {
  return (
    <section className="bg-black lg:h-200 h-170 pt-20 px-[20px] lg:px-20 overflow-hidden">
      <div className="flex flex-col  items-center lg:justify-between gap-10">
        ...
        >
          ...
          <p className="text-[#969696] text-[15px] font-semibold mt-6 lg:w-210 w-[100%] text-center lg:flex lg:mx-auto lg:justify-center">
        ...
        <motion.div
          ...
          className="lg:w-1/2 flex justify-center lg:justify-center  lg:mt-0"
        >
