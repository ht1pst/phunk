...
<img src={img1} alt=""  className=" w-50 h-7 md:w-30 md:h-4 lg:w-50 lg:h-7" />
<img src={img2} alt="" className="  w-40 h-10 md:w-25 md:h-5 lg:w-40 lg:h-10" />
<img src={img3} alt=""className=" w-50 h-10 md:w-30 md:h-5 lg:w-50 lg:h-10" />
...
<img src={img5} alt="" className="  w-40 h-10 md:w-30 md:h-7 lg:w-40 lg:h-10" />
<img src={img6} alt="" className="  w-50 h-10 md:w-30 md:h-7 lg:w-50 lg:h-10" />
<img src={img1} alt=""  className="  w-50 h-7 md:w-30 md:h-5 lg:w-50 lg:h-7"/>
