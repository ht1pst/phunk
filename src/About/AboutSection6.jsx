...
function AboutSection6() {
  ...
  return (
    <section className="bg-black lg:h-300 h-500 pt-20">
      ...
      {/* First Row */}
      <div className="flex flex-col px-4 lg:flex-row lg:gap-3 gap-[20px] justify-center pt-10">
        <motion.div
        ...
        >
          <div className="lg:px-5 lg:py-5 p-[20px]">
            ...
            <div className="flex justify-between items-end text-4xl">
                <div>
...
>
  01
            ...
            <p className="text-[#d7d7d7] lg:w-125 w-[100%]  text-[15px] pt-5 font-semibold">
...
>
  02
            ...
            <p className="text-[#d7d7d7] lg:w-125 w-[100%]  text-md pt-5 font-semibold">
...
>
  04
      ...
      >
        ...
        <p className="text-[#969696] lg:w-120 w-[100%]  text-center mx-auto lg:pt-5 pt-10 font-semibold text-[15px] px-[20px] leading-normal">
