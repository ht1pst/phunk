    ...
    >
      ...
      variants={fadeUp}
        >
          ...
          <p className="text-[#969696] lg:text-center w-100 lg:w-130 mx-auto mt-5">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6 pt-30 relative">
          ...
          >
            <img src={img1} alt="Joe Crabtree" className="w-130" />
            <h1 className="bg-gradient-to-r mt-7 px-7 from-[#00d1ff] to-[#004cff] bg-clip-text text-transparent text-3xl">
              Joe Crabtree
            </h1>
            <div className="px-7">
            ...
            <p className="text-gray-400 lg:w-120 w-90 mt-7 px-7">
          ...
          {/* Joe Murray */}
          <motion.div
            className="bg-[#0d0d0d] lg:w-130 mx-auto lg:mx-0 lg:h-170 h-140 w-90 rounded-xl"
            variants={fadeUp}
